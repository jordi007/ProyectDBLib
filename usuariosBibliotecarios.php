...
<body class="bg-light">
    ...
    <div class="container">
      <div class="row">
       ...
       <h2 class="h2">Listado de Bibliotecarios que son Suscriptores:</h2>
        </div>
        <div class="col-md-6 mx-auto">
          <?php
            ...
            if ($conn->getLink()){
              ...
              $biblio = Bibliotecario::listaBliotecariosSuscriptores($conn);
             ...
             if ($biblio) {
                ...
                echo '<table class="table">
                    ...
                    <tbody>';
              foreach ($biblio as $llave => $bi) {
                  echo '<tr>
                      <th scope="row">'.($llave+1).'</th>
                      <td>'.$bi->getNombre().'</td>
                      <td>'.$bi->getApellido().'</td>
                      <td>'.$bi->getEmail().'</td>
                      <td>'.$bi->getTelefono().'</td>';
