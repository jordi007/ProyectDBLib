...
try {
   ...
   $mail->SMTPDebug = 2;                                 // Enable verbose debug output
    ...
    //Recipients
    $mail->setFrom('biblioteca935bd@outlook.com', 'mail');
    $mail->addAddress('gabo21gonzalez@gmail.com', 'user');     // Add a recipient
    //$mail->addAddress('ellen@example.com');               // Name is optional
    $mail->addReplyTo('biblioteca935bd@outlook.com', 'mail');
